...
RSpec.describe BrigadeProject, :type => :model do
  describe 'validations' do
    it 'should not allow empty titles' do
      expect(FactoryGirl.build(:brigade_project_with_tags, title: '')).to_not be_valid
    end

    it 'should allow lack of tags' do
      expect(FactoryGirl.build(:brigade_project_with_tags)).to be_valid
    end

    it 'should allow empty description' do
      expect(FactoryGirl.build(:brigade_project_with_tags, 'description' => '')).to be_valid
    end
  end
  ...
  describe '.most_relevant' do
    describe 'when there are more than three projects for a particular brigade' do
      it 'returns at most three projects' do
        bp1 = FactoryGirl.create(:brigade_project_with_tags, title: 'proj1')
        bp2 = FactoryGirl.create(:brigade_project_with_tags, title: 'proj2')
        bp3 = FactoryGirl.create(:brigade_project_with_tags, title: 'proj3')
        bp4 = FactoryGirl.create(:brigade_project_with_tags, title: 'proj4')
        bp5 = FactoryGirl.create(:brigade_project_with_tags, title: 'proj5')
    ...
    describe 'when there are projects from multiple brigades' do
      it 'returns only projects from the current brigade' do
        bp1 = FactoryGirl.create(:brigade_project_with_tags, title: 'proj1', brigade_id: 1)
        bp2 = FactoryGirl.create(:brigade_project_with_tags, title: 'proj2', brigade_id: 2)
        bp3 = FactoryGirl.create(:brigade_project_with_tags, title: 'proj3', brigade_id: 1)
        bp4 = FactoryGirl.create(:brigade_project_with_tags, title: 'proj4', brigade_id: 2)
        bp5 = FactoryGirl.create(:brigade_project_with_tags, title: 'proj5', brigade_id: 1)
        bp6 = FactoryGirl.create(:brigade_project_with_tags, title: 'proj6', brigade_id: 3)
    ...
    describe 'when there are no projects for a particular brigade' do
      it 'returns all projects' do
        FactoryGirl.create(:brigade_project_with_tags, title: 'proj1', brigade_id: 2)
        most_relevant = BrigadeProject.most_relevant(1)
  ...
  describe '#tag_names' do
    describe 'when there are tags for multiple projects' do
      ...
      bp1 = FactoryGirl.create(:brigade_project_with_tags, brigade_id: 1, given_tags: tag_set_1)
      bp2 = FactoryGirl.create(:brigade_project_with_tags, brigade_id: 2, given_tags: tag_set_2)
    ...
    describe 'when there are no tags for the current project' do
      it 'should declare that no tag names exist' do
        ...
        bp1 = FactoryGirl.create(:brigade_project, brigade_id: 1)
        bp2 = FactoryGirl.create(:brigade_project_with_tags, brigade_id: 2, given_tags: tag_set)
        tag_names = bp1.tag_names
