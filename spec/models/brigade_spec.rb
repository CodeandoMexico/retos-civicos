...
describe Brigade do
  describe '#num_members' do
    let!(:brigade_with_users) { FactoryBot.create(:brigade_with_users) }
    ...
    describe 'no followers' do
      let!(:brigade) { FactoryBot.create(:brigade) }
  ...
  describe '.search' do
    let!(:location1) { FactoryBot.create(:location, city: 'Tequila', state: 'Jalisco') }
    let!(:location2) { FactoryBot.create(:location, city: 'Monterrey', state: 'Nuevo León') }
    let!(:location3) { FactoryBot.create(:location, city: 'Mazatlan', state: 'Sinaloa') }
    let!(:brigade) { FactoryBot.create(:brigade_with_users, location: location1) }
    let!(:brigade) { FactoryBot.create(:brigade, location: location2) }
    let!(:brigade) { FactoryBot.create(:brigade, location: location3) }
  ...
  describe 'Given an invalid brigade was created' do
    describe 'location' do
      describe 'Given the brigade has no location' do
        let(:brigade_without_location) { FactoryBot.build(:brigade, location: nil) }
    ...
    describe 'user' do
      describe 'Given the brigade has no user' do
        let(:brigade_without_user) { FactoryBot.build(:brigade, user: nil) }
    ...
    describe 'description' do
      describe 'Given the description is too long' do
        let(:brigade_with_long_description) { FactoryBot.build(:brigade, description: 'A' * 501) }
    ...
    describe 'calendar_url' do
      describe 'Given the calendar URL is too long' do
        let(:brigade_with_long_calendar_url) { FactoryBot.build(:brigade, calendar_url: 'A' * 501) }
      ...
      describe 'Given the calendar URL is not valid URL' do
        let(:brigade_with_invalid_calendar_url) { FactoryBot.build(:brigade, calendar_url: 'A' * 50) }
      ...
      #   let(:brigade_with_invalid_calendar_url) { FactoryBot.build(:brigade, calendar_url: "http://google.com") }
      #
    ...
    describe 'slack_url' do
      describe 'Given the slack URL is too long' do
        let(:brigade_with_long_slack_url) { FactoryBot.build(:brigade, slack_url: 'A' * 67) }
      ...
      describe 'Given the slack URL is not valid URL' do
        let(:brigade_with_invalid_slack_url) { FactoryBot.build(:brigade, slack_url: 'A' * 50) }
      ...
      describe 'Given the slack URL is not a valid Slack URL' do
        let(:brigade_with_invalid_slack_url) do
          FactoryBot.build(:brigade, slack_url: 'http://iamover21charssoiaminvalid.slack.com')
        end
    ...
    describe 'facebook_url' do
      describe 'Given the facebook URL is too long' do
        let(:brigade_with_long_facebook_url) { FactoryBot.build(:brigade, facebook_url: 'A' * 501) }
      ...
      describe 'Given the facebook URL is not valid URL' do
        let(:brigade_with_invalid_facebook_url) { FactoryBot.build(:brigade, facebook_url: 'A' * 50) }
      ...
      describe 'Given the facebook URL is not a valid Facebook URL' do
        let(:brigade_with_invalid_facebook_url) do
          FactoryBot.build(:brigade, facebook_url: 'http://facebook.com')
        end
    ...
    describe 'github_url' do
      describe 'Given the github URL is too long' do
        let(:brigade_with_long_github_url) { FactoryBot.build(:brigade, github_url: 'A' * 501) }
      ...
      describe 'Given the github URL is not valid URL' do
        let(:brigade_with_invalid_github_url) { FactoryBot.build(:brigade, github_url: 'A' * 50) }
      ...
      describe 'Given the github URL is not a valid Github URL' do
        let(:brigade_with_invalid_github_url) do
          FactoryBot.build(:brigade, github_url: 'http://facebook.com/')
        end
    ...
    describe 'twitter_url' do
      describe 'Given the twitter URL is too long' do
        let(:brigade_with_long_twitter_url) { FactoryBot.build(:brigade, twitter_url: 'A' * 501) }
      ...
      describe 'Given the twitter URL is not valid URL' do
        let(:brigade_with_invalid_twitter_url) { FactoryBot.build(:brigade, twitter_url: 'A' * 50) }
      ...
      describe 'Given the twitter URL is not a valid Twitter URL' do
        let(:brigade_with_invalid_twitter_url) do
          FactoryBot.build(:brigade, twitter_url: 'http://twitter.com/')
        end
    ...
    describe 'header_image_url' do
      describe 'Given the header_image URL is too long' do
        let(:brigade_with_long_header_image_url) { FactoryBot.build(:brigade, header_image_url: 'A' * 501) }
      ...
      describe 'Given the image header URL is not valid URL' do
        let(:brigade_with_invalid_header_image_url) { FactoryBot.build(:brigade, header_image_url: 'A' * 50) }
      ...
      describe 'Given the header image URL is not a valid image URL' do
        let(:brigade_with_invalid_header_image_url) do
          FactoryBot.build(:brigade, header_image_url: 'http://facebook.com/')
        end
    ...
    describe 'deactivated' do
      describe 'should be a boolean' do
        let(:brigade_with_invalid_deactivated) { FactoryBot.build(:brigade, header_image_url: 'A') }
