    ...
    describe ".find_or_create_by_name" do
      ...
      describe "given skill is present" do
        ...
        it "then it should return the existing skill" do
          expect(Skill.find_or_create_by_name(existing_skill_name).name).to equal(existing_skill_name)
        end
      end
      ...
      describe "given skill is not present" do
        ...
        it "then it should return the new skill" do
          expect(Skill.find_or_create_by_name(existing_skill_name).name).to equal(new_skill_name)
        end
      end
    end
  end
